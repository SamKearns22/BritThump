...
to `https://britthump.onrender.com`, so you only need to set this if you
move the site to a different address.
...
6. Deploy. Render gives you a URL like `britthump.onrender.com`.
...
- `logo.png` — the "BritThump" logo used in the site's masthead (the
  red/white/blue "Thump" is a real Union Jack clipped into the letters).
