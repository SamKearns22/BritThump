...
Your actual posts and images live in Supabase, not in this folder — there's
nothing else to back up beyond this code itself, since the code has no
secrets baked into it (those live in environment variables on your host).
